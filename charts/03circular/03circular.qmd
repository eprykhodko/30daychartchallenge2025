...
df <- read_delim("tz_opendata_z01012025_po01022025.csv", delim=';')
```
...
color_pie_chart <-function(data){
  data |> ggplot(aes(x= 1, y = n, fill = fct_relevel(COLOR, colors))) +
    ...
    theme(legend.position = "none", axis.ticks=element_blank(), axis.text.y = element_blank(), axis.text.x = element_blank())
