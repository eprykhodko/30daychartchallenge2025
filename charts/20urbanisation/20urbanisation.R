...
ukraine1 <- st_read("charts/20urbanisation/gadm41_UKR_1.json")
city <- read_csv("charts/20urbanisation/city.csv") |> mutate(`GID_1` = glue::glue("{GID_1}_1"), pct=parse_integer(str_match(VALUE, "\\d+")))
